        ...
        <div className="bg-gray-200 min-h-screen">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 pt-20 flex flex-col lg:flex-row lg:space-x-6">
                <div className="w-full lg:w-2/3 space-y-6">
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
                        <h2 className="flex items-center text-lg font-semibold mb-4">
                            ...
                            Contact Number
                            <button onClick={addContact} className="ml-auto text-[#057A55] text-sm">+ Add</button>
                        </h2>
                        {contacts.map((contact, index) => (
                            <div key={index} className="flex items-center border rounded-lg p-2 mb-2">
                                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/1200px-Flag_of_India.svg.png" alt="Flag" className="h-5 mr-2" />
                                <span>+91</span>
                                <input
                                    type="text"
                    ...
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
                        <h2 className="flex items-center text-lg font-semibold mb-4">
                            ...
                            Billing Address
                            <button onClick={() => addAddress('billing')} className="ml-auto text-[#057A55] text-sm">+ Add</button>
                        </h2>
                    ...
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
                        <h2 className="flex items-center text-lg font-semibold mb-4">
                            ...
                            Shipping Address
                            <button onClick={() => addAddress('shipping')} className="ml-auto text-[#057A55] text-sm">+ Add</button>
                        </h2>
                ...
                <div className="w-full lg:w-1/3 h-fit bg-white p-4 sm:p-8 rounded-lg shadow mt-6 lg:mt-0">
                    ...
                    <button
                        className="w-full bg-[#057A55] text-white py-2 rounded-full mt-4 cursor-pointer disabled:opacity-50"
